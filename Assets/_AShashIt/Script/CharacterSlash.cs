...
public class CharacterSlash : MonoBehaviour
{
  ...
  {
    Camera.main.transform.position = new Vector3(Mathf.Lerp(Camera.main.transform.position.x, transform.position.x, Time.deltaTime * 10f), Mathf.Lerp(Camera.main.transform.position.y, transform.position.y + 1, Time.deltaTime * 10f), -10);
